...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2021 a las 03:14:01
...
-- Procedimientos
--
CREATE PROCEDURE `sp_d_usuario_01` (IN `xusu_id` INT)  BEGIN
	UPDATE tm_usuario 
	SET 
		est='0',
		fech_elim = now() 
...
CREATE PROCEDURE `sp_i_ticketdetalle_01` (IN `xtick_id` INT, IN `xusu_id` INT)  BEGIN
...
CREATE PROCEDURE `sp_l_usuario_01` ()  BEGIN
	SELECT * FROM tm_usuario where est='1';
END$$

CREATE PROCEDURE `sp_l_usuario_02` (IN `xusu_id` INT)  BEGIN
...
(1, 'TAPJE', 'Informatica', 'informatica@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 2, '2023-10-21 19:46:22', NULL, NULL, 1),
(2, 'TAPJE', 'usuario', 'usuario@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, '2023-10-21 19:46:22', NULL, NULL, 1);
