    ...
    class Ticket extends Conectar{
        ...
        public function listar_ticket_x_usu($usu_id){
            ...
            $sql="SELECT 
                ...
                tm_ticket.fech_asig,
                cat_usuarios.nombre,
                cat_usuarios.paterno,
                tm_categoria.cat_nom
                FROM 
                tm_ticket
                INNER join tm_categoria on tm_ticket.cat_id = tm_categoria.cat_id
                INNER join cat_usuarios on tm_ticket.usu_id = cat_usuarios.id_usuario
                WHERE
                tm_ticket.est = 1
                AND cat_usuarios.id_usuario=?";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $usu_id);
            $sql->execute();
        ...
        public function listar_ticketdetalle_x_ticket($tick_id){
            ...
            cat_usuarios.nombre,
            cat_usuarios.paterno,
            cat_usuarios.id_usuario
            FROM 
            td_ticketdetalle
            INNER JOIN cat_usuarios ON td_ticketdetalle.usu_id = cat_usuarios.id_usuario
            WHERE 
            tick_id =?";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $tick_id);
