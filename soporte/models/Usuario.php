        ...
        public function login(){
            ...
            if(isset($_POST["enviar"])){
                ...
                if(empty($correo) and empty($pass)){
                    ...
                    $sql = "SELECT * FROM cat_usuarios WHERE email=? && password=MD5(?) && id_usuario=? && activo=1";
                    ...
                    if (is_array($resultado) and count($resultado)>0){
                        //variables         campos de bd
                        $_SESSION["usu_id"]=$resultado["id_usuario"];
                        $_SESSION["usu_nom"]=$resultado["nombre"];
                        $_SESSION["usu_ape"]=$resultado["paterno"];
                        $_SESSION["rol_id"]=$resultado["rol_id"];
                        header("Location:".Conectar::ruta()."../Portal\index.php"); //envia al usuario al dashboard del portal empleadov2
